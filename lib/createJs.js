            ...
            try {
                ...
                for (let apiObject of ApiItem) {
                    ...
                    for (let req of apiObject.request) {
                        ...
                        apiObject.paramsTags.push(`\t * @param {${req.type}} req.${req.code} - ${req.mustName} ${req.note}`)
                    }
                    for (let res of apiObject.response) {
                        ...
                        apiObject.resParamsTags.push(`\t * @param {${res.type}} res.${res.code} - ${res.mustName} ${res.note}`)
                    }
