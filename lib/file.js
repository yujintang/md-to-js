...
module.exports = {
    ...
    transMd: function (file) {
        ...
        return new promise(function (resolve) {
            ...
            lr.on('line', function (line) {
                ...
                if (reg2.test(line)) {
                    count++;
                    temp.router = reg2.exec(line)[2];
                    temp.mockUrl = path.basename(reg2.exec(line)[1] + '_' + reg2.exec(line)[2]) + '.do.js';
                }
    ...
    writeJs: function (file, allArr) {
        ...
        for (let i of allArr) {
            ...
            //每个api接口的代码
            let tempCode = utils.api_template(i, body, paramDetail, tempBody, params);
