    ...
    this.${api.router}${method} = async(req) => {
        ...
        try {
            /*let session = req.session, active_user = session.active_user, 
                user_id = active_user.user.user_id, 
                plat_id = active_user.plat.plat_id, 
                corp_id = active_user.corp.corp_id,
